...
func (tx *Tx) init() {
	tx.CrawledUrl = NewCrawledUrlClient(tx.config)
	tx.LinkUrl = NewLinkUrlClient(tx.config)
}
...
// applies a query, for example: CrawledUrl.QueryXXX(), the query will be executed
